...
num_ftrs = model_vgg19.classifier[6].in_features  # VGG19'un son katmanı
model_vgg19.classifier[6] = nn.Linear(num_ftrs, len(siniflar))  # Kather Texture 5K veri seti için 8 sınıf

model_vgg19 = model_vgg19.to(device)

criterion = nn.CrossEntropyLoss()
optimizer = optim.SGD(model_vgg19.classifier[6].parameters(), lr=0.001, momentum=0.9)
