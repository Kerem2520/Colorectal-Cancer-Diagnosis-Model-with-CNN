...
num_ftrs = model_mobilenet.classifier[1].in_features  # MobileNet'in son katmanı
model_mobilenet.classifier[1] = nn.Linear(num_ftrs, len(siniflar))  # Kather Texture 5K veri seti için 8 sınıf

model_mobilenet = model_mobilenet.to(device)

criterion = nn.CrossEntropyLoss()
optimizer = optim.SGD(model_mobilenet.classifier[1].parameters(), lr=0.001, momentum=0.9)
